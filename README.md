...
Full-Stack Developer | Builds apps, breaks them, fixes them again | Exploring AI technologies

<!--
**Suhaas22/Suhaas22** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
-->

- 🔭 I build full-stack web applications using React & Django
- 👯 I enjoy collaborating on meaningful tech projects and hackathons
- 💬 Ask me about full-stack development, REST APIs, or ML/DL fundamentals
- ⚡ Fun fact: Debugging AI models and backend code requires the same patience
